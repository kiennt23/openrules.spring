...
rem if a decision model is going to be imported you need to set ADDITIONAL_GOALS=true
if "%ADDITIONAL_GOALS%" == "" set ADDITIONAL_GOALS=true
...
java -Xmx512m -classpath "%ALL%" %CLASS_NAME% "file:%INPUT_FILE_NAME%" %GOAL% "%OUTPUT_FILE_NAME%" "%ADDITIONAL_GOALS%"
echo done